...
use Yii;
use app\models\Exam;
use app\models\search\Examsearch;
...
class ExamController extends Controller
{
    ...
    {
        $u_model = new \app\models\UploadForm();
        $filename='';
        if (Yii::$app->request->isPost) {
            $u_model->file = \yii\web\UploadedFile::getInstance($u_model, 'file');
            if ($u_model->file && $u_model->validate()) {
                $filename='uploads/' . $u_model->file->baseName . '.' . $u_model->file->extension;
                $u_model->file->saveAs($filename);
            }
        }
        $post=Yii::$app->request->post();
        $post['Exam']['file']=$filename;
        $model = new Exam();
